...
export default function App({ navigation }) {
  const [data, setData] = useState([
    ...
    { key: '1', type: 'Vegetable', name: 'Pear', price: '28.00', image: require('../assets/Data/Image 107.png') },
  ...
  return (
    <ScrollView stickyHeaderIndices={[0]}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={{ justifyContent: 'center', alignItems: 'center', width: '45%', marginHorizontal: '2.5%', marginVertical: 10, padding: 15 }}>
            <TouchableOpacity onPress={() => navigation.navigate('Screen_03')}>
